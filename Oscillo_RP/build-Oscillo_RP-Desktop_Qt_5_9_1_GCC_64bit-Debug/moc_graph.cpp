...
QT_MOC_LITERAL(1, 6, 10), // "graph_done"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 13), // "socket_closed"
QT_MOC_LITERAL(4, 32, 4), // "plot"
QT_MOC_LITERAL(5, 37, 19), // "TcpParameterWindow*"
QT_MOC_LITERAL(6, 57, 3) // "tpw"

    },
    "Graph\0graph_done\0\0socket_closed\0plot\0"
    "TcpParameterWindow*\0tpw"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->graph_done(); break;
        case 1: _t->socket_closed(); break;
        case 2: _t->plot((*reinterpret_cast< TcpParameterWindow*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 2:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< TcpParameterWindow* >(); break;
            }
            break;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Graph::graph_done)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Graph::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Graph::socket_closed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Graph::graph_done()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Graph::socket_closed()
{
